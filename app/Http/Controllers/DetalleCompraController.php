...
class DetalleCompraController extends Controller
{
    ...
    {
        return detalleCompra::create($request->all());
    }
    ...
    {
        return detalleCompra::where('id', $id)->get();
    }
    ...
    {
        detalleCompra::where('id', $id)->first()->update($request->all());
    }
    ...
    {
        detalleCompra::where('id', $id)->first()->delete();
    }
}
