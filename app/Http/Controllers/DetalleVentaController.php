...
class DetalleVentaController extends Controller
{
    ...
    {
        return detalleVenta::create($request->all());
    }
    ...
    {
        return detalleVenta::where('id', $id)->get();
    }
    ...
    {
        detalleVenta::where('id', $id)->first()->update($request->all());
    }
    ...
    {
        detalleVenta::where('id', $id)->first()->delete();
    }
}
